...
/**
 * Generated class for the ChatFriendsActivePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-chat-friends-active',
  templateUrl: 'chat-friends-active.html',
})
export class ChatFriendsActivePage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ChatFriendsActivePage');
  }
